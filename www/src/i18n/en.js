Object.assign((typeof window === 'undefined' ? module.exports : window).i18n = (typeof window === 'undefined' ? module.exports : window).i18n || {}, {
  en: {
    TitleText: 'Connect on Chat',
    DescriptionText: 'Chat is a messaging app that works over e-mail.',
    FormBlurbText: 'Create a Chat invite link',
    StepCodeText: 'Open Chat, then navigate to <b>QR code → Show QR Invite Code → Copy to Clipboard</b>',
