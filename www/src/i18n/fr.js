Object.assign((typeof window === 'undefined' ? module.exports : window).i18n = (typeof window === 'undefined' ? module.exports : window).i18n || {}, {
  fr: {
    TitleText: 'Connecte sur Chat',
    DescriptionText: 'Chat est une application de messagerie qui fonctionne par e-mail.',
    FormBlurbText: "Crée un lien d'invitation à Chat",
    StepCodeText: "Ouvre Chat, navigue jusqu'à <b>QR code → Afficher le code d'invitation QR → Copier dans le presse-papiers </b>.",
